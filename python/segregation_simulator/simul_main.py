...
for growth_rate in (1.0, other_strain_growth_rate):
    ...
    for n in range(number_simulations):
        ...
        f, g = family_simulator(
            start_cell, ngen, 
            other_strain_growth_rate=growth_rate
        )
...
final_df = pd.concat(dfs, names=['growth_rate', 'simulation_index'])
